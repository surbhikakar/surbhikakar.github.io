...
const translations = {
    en: {
        ...
        "pillars.title": "Ways to Practise",
        "pillars.subtitle": "The same attention, practised three ways",
        ...
        "pillars.children.desc": "An eight-week course for children aged 5 to 12, and a ten-week course for teens aged 12 to 18. Small groups, playful practice, and no way to get it wrong. Based on the Eline Snel method.",
        "pillars.children.link": "See the courses →",
        "pillars.yoga.link": "Ask about classes →",
        "pillars.adults.title": "Mindfulness for Adults",
        "pillars.adults.desc": "A workshop for the busy mind: an unhurried afternoon to step out of the noise of the head and back into the body. Next date Saturday 26 September, at Shiva Yoga Center.",
        "pillars.adults.flag": "Booking open",
        "pillars.adults.link": "See the workshop →",
        ...
        "offer.s3.blurb": "A pilot course for teens, in two groups: 12 to 14 and 14 to 18. For a full head, school pressure, and finding some steadiness of your own.",
        "outcomes.4.title": "Getting still",
        "outcomes.4.desc": "Like sand settling in a jar of water, a busy mind clears when it is given a moment. From that quiet, it becomes easier to see clearly and know what to do.",

        // Navigation - workshops
        "nav.workshops": "Workshops",

        // Footer - business details
        "footer.legal": "Business Details",
        "footer.legal.text": "Surbhi Kakar<br>KvK 42132434<br>BTW NL005521243B46",

        // Workshop page - Fresh as a Flower
        "ws.badge": "Booking open",
        "ws.eyebrow": "Mindfulness Workshop · Amstelveen",
        "ws.title": "Fresh as a Flower",
        "ws.lede": "A mindfulness workshop for the busy mind.",
        "ws.caption": "Saturday 26 September, Shiva Yoga Center, Amstelveen.",
        "ws.intro.1": "Does your mind find it hard to slow down? Does it race ahead into worry, circle the same thoughts, plan and re-plan, and rarely rest in the present moment?",
        "ws.intro.2": "If so, this afternoon is for you. A busy mind is often a caring mind, one working hard to keep everything safe. This workshop is a gentle invitation to step out of the noise of the head and back into the body, where things move more slowly and there is room to breathe.",
        "ws.list.title": "Over 2.5 unhurried hours we will",
        "ws.list.1": "Come home to the body through mindful movement and breath",
        "ws.list.2": "Let our feelings move, instead of pushing them down",
        "ws.list.3": "Slow right into the present with a mindful eating practice",
        "ws.list.4": "Rest deeply in a guided relaxation",
        "ws.list.5": "Share in a warm, supportive circle",
        "ws.noexp": "No experience needed. Nothing to achieve. Simply arrive as you are.",
        "ws.who": "For anyone who overthinks, worries, carries a lot for others, or longs to feel more grounded.",
        "ws.details.title": "Practical Details",
        "ws.facts.date": "Date",
        "ws.facts.date.v": "Saturday 26 September 2026",
        "ws.facts.time": "Time",
        "ws.facts.time.v": "14:00 – 16:30",
        "ws.facts.where": "Where",
        "ws.facts.where.v": "Shiva Yoga Center<br>Lindenlaan 75, Amstelveen",
        "ws.facts.lang": "Language",
        "ws.facts.lang.v": "English",
        "ws.facts.price": "Price",
        "ws.facts.price.v": "€45",
        "ws.cta": "Book Your Place",
        "ws.note": "Booking is handled by Shiva Yoga Center through Eversports.",
        "ws.ask.title": "Not Sure If It Is For You?",
        "ws.ask.text": "If you have a question about the afternoon, or would like to know whether it suits where you are right now, do get in touch. There is no obligation.",
        "ws.ask.btn": "Ask a Question",
    },
    ...
    nl: {
        ...
        "pillars.title": "Manieren om te oefenen",
        "pillars.subtitle": "Dezelfde aandacht, op drie manieren geoefend",
        "pillars.yoga.title": "Yoga",
        ...
        "pillars.children.desc": "Een cursus van acht lessen voor kinderen van 5 tot 12 jaar, en een cursus van tien lessen voor tieners van 12 tot 18 jaar. Kleine groepen, speels oefenen, en je kunt het niet fout doen. Volgens de methode van Eline Snel.",
        ...
        "pillars.adults.desc": "Een workshop voor een druk hoofd: een rustige middag om uit het lawaai van je hoofd te stappen en terug te keren naar je lichaam. Eerstvolgende datum zaterdag 26 september, bij Shiva Yoga Center.",
        "pillars.adults.flag": "Inschrijving geopend",
        "pillars.adults.link": "Bekijk de workshop →",
        ...
        "offer.s3.blurb": "Een pilotcursus voor tieners, in twee groepen: 12 tot 14 en 14 tot 18 jaar. Voor een vol hoofd, schooldruk, en het vinden van je eigen rust.",
        "outcomes.4.title": "Even stil worden",
        "outcomes.4.desc": "Zoals zand dat neerdaalt in een pot water, wordt een druk hoofd helder als het even de tijd krijgt. Vanuit die rust zie je helder en weet je wat te doen.",
        ...
        // Workshoppagina - Fresh as a Flower
        "ws.badge": "Inschrijving geopend",
        "ws.eyebrow": "Mindfulness workshop · Amstelveen",
        "ws.title": "Fresh as a Flower",
        "ws.lede": "Een mindfulness workshop voor een druk hoofd.",
        "ws.caption": "Zaterdag 26 september, Shiva Yoga Center, Amstelveen.",
        "ws.intro.1": "Valt het je hoofd zwaar om tot rust te komen? Schiet het vooruit naar zorgen, draait het rondjes om dezelfde gedachten, plant en herplant het, en komt het zelden tot rust in het hier en nu?",
        "ws.intro.2": "Dan is deze middag voor jou. Een druk hoofd is vaak een zorgzaam hoofd, dat hard werkt om alles veilig te houden. Deze workshop is een zachte uitnodiging om uit het lawaai van je hoofd te stappen en terug te keren naar je lichaam, waar het langzamer gaat en er ruimte is om te ademen.",
        "ws.list.title": "In 2,5 rustige uren gaan we",
        "ws.list.1": "Thuiskomen in het lichaam, via aandachtige beweging en adem",
        "ws.list.2": "Onze gevoelens laten bewegen, in plaats van ze weg te duwen",
        "ws.list.3": "Helemaal vertragen in het moment, met een eetmeditatie",
        "ws.list.4": "Diep rusten in een geleide ontspanning",
        "ws.list.5": "Delen in een warme, ondersteunende kring",
        "ws.noexp": "Geen ervaring nodig. Niets te bereiken. Kom gewoon zoals je bent.",
        "ws.who": "Voor iedereen die veel nadenkt, piekert, veel draagt voor anderen, of verlangt naar meer grond onder de voeten.",
        "ws.details.title": "Praktische informatie",
        "ws.facts.date": "Datum",
        "ws.facts.date.v": "Zaterdag 26 september 2026",
        "ws.facts.time": "Tijd",
        "ws.facts.time.v": "14:00 – 16:30",
        "ws.facts.where": "Waar",
        "ws.facts.where.v": "Shiva Yoga Center<br>Lindenlaan 75, Amstelveen",
        "ws.facts.lang": "Taal",
        "ws.facts.lang.v": "Engels",
        "ws.facts.price": "Prijs",
        "ws.facts.price.v": "€45",
        "ws.cta": "Reserveer je plek",
        "ws.note": "De reservering loopt via Shiva Yoga Center op Eversports.",
        "ws.ask.title": "Twijfel je of het iets voor je is?",
        "ws.ask.text": "Heb je een vraag over deze middag, of wil je weten of het past bij waar je nu staat? Neem gerust contact op. Geheel vrijblijvend.",
        "ws.ask.btn": "Stel een vraag",
    }
};
