...
const translations = {
    en: {
        ...
        "offer.title": "Choose Your Child's Group",
        "offer.lede": "Based on the Eline Snel method. Lessons are taught in English.",
        ...
        "outcomes.1.title": "Calm",
        "outcomes.1.desc": "A pause before reacting. Children learn that there is a moment between what happens and what they do, and that the breath is always with them.",
        "outcomes.2.title": "Focus at School",
        "outcomes.2.desc": "Attention wanders, for everyone. Children learn that noticing this is the practice, and that attention can always be brought back.",
        "outcomes.3.title": "Knowing Their Feelings",
        "outcomes.3.desc": "Anger, sadness and worry are allowed here. Children learn to notice and name them, and discover that feelings pass, like weather.",
    ...
    nl: {
        ...
        "offer.title": "Kies de groep van uw kind",
        "offer.lede": "Volgens de methode van Eline Snel. De lessen zijn in het Engels.",
        ...
        "outcomes.1.title": "Rust",
        "outcomes.1.desc": "Even stoppen voordat je reageert. Kinderen leren dat er een moment zit tussen wat er gebeurt en wat je doet, en dat hun adem er altijd is.",
        "outcomes.2.title": "Beter concentreren op school",
        "outcomes.2.desc": "Aandacht dwaalt af, bij iedereen. Kinderen leren dat juist het opmerken de oefening is, en dat je je aandacht steeds opnieuw terug kunt brengen.",
        "outcomes.3.title": "Je gevoelens leren kennen",
